...
def gradient_variance_when_training():
    def read_floats_from_file(f):
        x_arr = []
        with open(f, 'r') as fptr:
            lines = fptr.readlines()
            for line in lines:  # line is like: E0001: 0.00064728
                line = line.strip()
                if line.startswith('#') or line == '': continue
                x = line.split()[1]
                x = float(x)
    ...
    fn1 = 'predicted_gradient_variance_ckpt_gnobitab_CIFAR10_ReRF2-0.0.txt'
    fn2 = 'predicted_gradient_variance_ckpt_gnobitab_CIFAR10_ReRF2-0.1.txt'
    lambda_false = read_floats_from_file(os.path.join(root_dir, fn1))
    lambda_0_1   = read_floats_from_file(os.path.join(root_dir, fn2))
    print(f"ReRF2-lambda-False: {len(lambda_false)}")
    print(f"ReRF2-lambda-0.1  : {len(lambda_0_1)}")
    lambda_false = [var * 10000 for var in lambda_false]
...
def track_training_curve_of_loss():
    # loss of baseline, 1RF to 2RF
    def plot(list1, list2, ith, ema_rate=0.9, k=0):
        epoch_arr = list(range(1, len(list1) + 1))
        if k > 0:  # ignore some items
            list1, list2, epoch_arr = list1[k:], list2[k:], epoch_arr[k:]
        list1 = [f * 1000 for f in list1]
        list2 = [f * 1000 for f in list2]
        ema = list1[0]
        for i in range(1, len(list1)):
            ema = ema * ema_rate + list1[i] * (1 - ema_rate)
            list1[i] = ema
        ema = list2[0]
    ...
    ls_bl_01 = [1100, 765, 705, 677, 653, 643, 633, 620, 621, 609, 605, 604, 601, 594, 594, 588, 590, 584, 585, 580,
                578, 578, 578, 579, 575, 569, 572, 574, 568, 566, 569, 569, 564, 569, 564, 568, 563, 563, 563, 564,
                560, 560, 561, 561, 559, 561, 560, 558, 559, 555, 557, 554, 553, 554, 555, 552, 552, 553, 555, 555,
                556, 553, 555, 550, 546, 553, 553, 547, 548, 548, 552, 548, 549, 548, 549, 549, 547, 548, 547, 547,
                547, 546, 546, 546, 545, 547, 544, 546, 546, 544, 546, 543, 545, 547, 541, 542, 543, 543, 547, 543,
                543, 541, 543, 542, 543, 542, 542, 541, 538, 544, 542, 544, 542, 541, 541, 541, 542, 541, 539, 540,
                541, 539, 540, 539, 539, 538, 538, 539, 540, 541, 541, 540, 540, 539, 541, 539, 536, 538, 539, 540,
                537, 537, 539, 539, 539, 538, 536, 535, 537, 538, 534, 539, 538, 536, 537, 536, 538, 537, 537, 538,
                538, 539, 532, 537, 534, 539, 536, 536, 534, 536, 535, 535, 535, 536, 535, 536, 534, 534, 535, 534,
                534, 534, 534, 534, 536, 535, 535, 535, 532, 537, 534, 536, 534, 534, 534, 536, 532, 532, 533, 533,
                531, 532, 533, 534, 537, 533, 535, 533, 531, 532, 533, 532, 535, 530, 532, 533, 531, 531, 533, 533,
                532, 534, 533, 531, 533, 532, 532, 529, 531, 529, 532, 532, 531, 532, 531, 532, 534, 530, 530, 529,
                531, 530, 532, 531, 532, 531, 529, 528, 529, 530, 529, 532, 532, 530, 530, 533, 529, 529, 530, 528,
                531, 533, 530, 529, 528, 531, 528, 530, 531, 528, 530, 530, 530, 531, 531, 529, 530, 530, 528, 531,
                528, 528, 529, 530, 528, 529, 527, 528, 531, 529, 528, 529, 527, 528, 530, 529, 527, 529, 529, 528,
                515, 517, 516, 517, 519, 517, 518, 515, 515, 517, 515, 516, 515, 517, 518, 516, 514, 516, 516, 518,
                517, 515, 517, 513, 517, 519, 516, 516, 515, 515, 517, 515, 515, 512, 516, 515, 517, 514, 517, 517,
                515, 516, 515, 515, 515, 515, 513, 517, 516, 516, 515, 516, 514, 517, 515, 517, 517, 517, 515, 513,
                514, 515, 514, 515, 515, 515, 515, 516, 515, 516, 515, 514, 511, 514, 516, 514, 515, 515, 514, 516,
                517, 514, 513, 513, 512, 515, 514, 513, 513, 514, 514, 514, 514, 512, 512, 513, 517, 512, 514, 515,
                514, 513, 514, 513, 515, 512, 513, 512, 515, 513, 513, 514, 513, 512, 512, 513, 514, 513, 514, 513,
                512, 513, 512, 512, 514, 512, 513, 513, 513, 512, 513, 512, 511, 511, 512, 512, 512, 512, 512, 514,
                513, 511, 513, 513, 509, 512, 512, 512, 511, 512, 511, 512, 511, 510, 512, 511, 514, 513, 511, 511,
                514, 512, 511, 513, 511, 511, 511, 512, 510, 509, 511, 509, 514, 512, 510, 513, 510, 512, 510, 511]
    ls_bl_01 = [f / 3072 for f in ls_bl_01] # 3072 = 32*32*3
    ls_cg_01 = [f / 3072 for f in ls_cg_01]
    plot(ls_bl_01, ls_cg_01, 1, k=10)

    ls_bl_12 = [0.0057, 0.0047, 0.0047, 0.0043, 0.0039, 0.0034, 0.0034, 0.0038, 0.0036, 0.0037, # baseline
                0.0033, 0.0030, 0.0029, 0.0030, 0.0033, 0.0036, 0.0030, 0.0030, 0.0031, 0.0030,
                0.0032, 0.0029, 0.0031, 0.0027, 0.0027, 0.0027, 0.0027, 0.0031, 0.0027, 0.0028,
                0.0028, 0.0026, 0.0028, 0.0025, 0.0028, 0.0030, 0.0025, 0.0026, 0.0027, 0.0026,
                0.0028, 0.0026, 0.0027, 0.0024, 0.0029, 0.0024, 0.0028, 0.0026, 0.0027, 0.0029,
                0.0021, 0.0022, 0.0030, 0.0022, 0.0027, 0.0025, 0.0025, 0.0021, 0.0024, 0.0022,
                0.0022, 0.0024, 0.0026, 0.0020, 0.0025, 0.0030, 0.0021, 0.0025, 0.0022, 0.0021,
                0.0021, 0.0026, 0.0024, 0.0023, 0.0019, 0.0024, 0.0022, 0.0023, 0.0021, 0.0023,
                0.0021, 0.0019, 0.0020, 0.0024, 0.0022, 0.0024, 0.0021, 0.0030, 0.0021, 0.0021,
                0.0021, 0.0022, 0.0022, 0.0028, 0.0019, 0.0021, 0.0020, 0.0020, 0.0019, 0.0019]
    ls_cg_12 = [0.0094, 0.0049, 0.0044, 0.0041, 0.0039, 0.0038, 0.0036, 0.0036, 0.0034, 0.0034, # consistent-gradient
                0.0033, 0.0032, 0.0032, 0.0031, 0.0031, 0.0030, 0.0029, 0.0029, 0.0029, 0.0028,
                0.0028, 0.0028, 0.0027, 0.0027, 0.0027, 0.0027, 0.0026, 0.0026, 0.0026, 0.0025,
                0.0025, 0.0025, 0.0025, 0.0025, 0.0024, 0.0024, 0.0024, 0.0024, 0.0024, 0.0024,
                0.0023, 0.0023, 0.0023, 0.0023, 0.0023, 0.0023, 0.0023, 0.0023, 0.0022, 0.0022,
                0.0022, 0.0022, 0.0022, 0.0021, 0.0022, 0.0022, 0.0021, 0.0022, 0.0021, 0.0021,
                0.0021, 0.0021, 0.0021, 0.0021, 0.0021, 0.0021, 0.0020, 0.0020, 0.0020, 0.0020,
                0.0020, 0.0020, 0.0020, 0.0020, 0.0020, 0.0020, 0.0020, 0.0020, 0.0020, 0.0020,
                0.0019, 0.0019, 0.0019, 0.0019, 0.0019, 0.0019, 0.0019, 0.0020, 0.0019, 0.0019,
                0.0019, 0.0019, 0.0019, 0.0019, 0.0019, 0.0019, 0.0019, 0.0019, 0.0018, 0.0018]
    plot(ls_bl_12, ls_cg_12, 2, k=2)

    ls_bl_23 = [0.0016, 0.0010, 0.0011, 0.0010, 0.0009, 0.0011, 0.0010, 0.0011, 0.0010, 0.0011,
                0.0011, 0.0013, 0.0010, 0.0009, 0.0010, 0.0010, 0.0011, 0.0010, 0.0011, 0.0010,
                0.0011, 0.0010, 0.0010, 0.0011, 0.0010, 0.0010, 0.0013, 0.0010, 0.0009, 0.0011,
                0.0009, 0.0010, 0.0009, 0.0009, 0.0010, 0.0009, 0.0008, 0.0010, 0.0011, 0.0010,
                0.0009, 0.0012, 0.0010, 0.0008, 0.0009, 0.0009, 0.0009, 0.0009, 0.0008, 0.0009,
                0.0008, 0.0008, 0.0009, 0.0010, 0.0009, 0.0008, 0.0011, 0.0008, 0.0010, 0.0010,
                0.0008, 0.0009, 0.0008, 0.0008, 0.0009, 0.0009, 0.0008, 0.0008, 0.0010, 0.0008,
                0.0009, 0.0009, 0.0009, 0.0009, 0.0009, 0.0010, 0.0009, 0.0007, 0.0009, 0.0007,
                0.0008, 0.0008, 0.0008, 0.0009, 0.0007, 0.0008, 0.0008, 0.0009, 0.0008, 0.0008,
                0.0008, 0.0007, 0.0009, 0.0007, 0.0008, 0.0009, 0.0008, 0.0010, 0.0007, 0.0009]
    ls_cg_23 = [0.0011, 0.0010, 0.0011, 0.0011, 0.0009, 0.0010, 0.0010, 0.0012, 0.0009, 0.0010,
                0.0009, 0.0009, 0.0011, 0.0009, 0.0009, 0.0010, 0.0009, 0.0009, 0.0009, 0.0009,
                0.0010, 0.0009, 0.0008, 0.0010, 0.0008, 0.0010, 0.0010, 0.0010, 0.0008, 0.0009,
                0.0008, 0.0008, 0.0009, 0.0008, 0.0009, 0.0009, 0.0008, 0.0007, 0.0009, 0.0009,
                0.0009, 0.0009, 0.0008, 0.0009, 0.0008, 0.0008, 0.0008, 0.0009, 0.0008, 0.0008,
                0.0008, 0.0008, 0.0008, 0.0008, 0.0008, 0.0007, 0.0008, 0.0007, 0.0008, 0.0007,
                0.0009, 0.0009, 0.0008, 0.0008, 0.0008, 0.0008, 0.0008, 0.0007, 0.0008, 0.0008,
                0.0009, 0.0008, 0.0009, 0.0008, 0.0007, 0.0008, 0.0007, 0.0008, 0.0008, 0.0008,
                0.0007, 0.0007, 0.0010, 0.0008, 0.0008, 0.0008, 0.0007, 0.0008, 0.0008, 0.0007,
                0.0008, 0.0007, 0.0007, 0.0007, 0.0008, 0.0007, 0.0007, 0.0006, 0.0008, 0.0006]
    plot(ls_bl_23, ls_cg_23, 3)
